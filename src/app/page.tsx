    ...
    <main className="flex flex-col min-h-[100dvh] space-y-10">
      ...
      <section id="about">
        ...
        <BlurFade delay={BLUR_FADE_DELAY * 4}>
          <Markdown className="mt-1 prose max-w-full text-pretty font-sans text-sm text-muted-foreground dark:prose-invert">
            {DATA.summary}
          </Markdown>
        </BlurFade>
      </section>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  I love creating tech projects and turning ideas into real products. Here are a few of my favorites.
                </p>
              </div>
            </div>
          </BlurFade>
