...
,
  ...
  contact: {
    ...
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/ravishanamina174",
        icon: Icons.github,
      ...
      X: {
        name: "X",
        url: "https://x.com/ravisha_abey07?s=21&t=AOUiu82WcyIBUPG8a9-Wig",
        icon: Icons.x,
        navbar: true,
      },
      // Youtube: {
  ...
  education: [
    ...
    {
      school: "Sivali Central College / Rathnapura",
...
certifications: [
    {
      school: "Full-stack Engineer Professional Certification",
      href: "https://stemlink.online/certificates/cmfhwjphl0001k1io0p9c62li",
      degree: "Successfully completed 4-month Advanced Full-stack Engineer Bootcamp, mastering MERN Stack (MongoDB, Express.js, React.js, Node.js) and building a feature-rich E-commerce platform project.",
      logoUrl: "/stem.png",
      start: "June",
      end: "Oct 2025",
    },
  ...
  projects: [
    {
      ...
      links: [
        ...
        {
          type: "Source",
          href: "https://github.com/ravishanamina174/my-react-node-app",
    ...
    },
    {
      ...
      links: [
        ...
        {
          type: "Source",
          href: "https://github.com/ravishanamina174/tcc-frontend",
          icon: <Icons.github className="size-3" />,
        },
      ],
      image: "/parknet.png",
